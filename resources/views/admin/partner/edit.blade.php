...
<div class="panel panel-default">
    <div class="panel-heading">
        <h2><i class="fa fa-indent red"></i><strong>修改合作伙伴</strong></h2>
    </div>
    <div class="col-lg-12">
       @if (count($errors) > 0)
    ...
    <form action="{{ route('partner.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal ">
        ...
        <div class="panel-footer">
            ...
            <button type="button" class="btn btn-sm btn-close" onclick="window.location.href='{{ route('partner.index') }}'"><i class="fa fa-dot-circle-o"></i> 返回</button>

...
@section('content')
    ...
    <form class="form form-horizontal" id="form-article-add" action="{{ url('admin/news/pictures/update') }}" method="POST">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                datatype="*10-100" dragonfly="true" nullmsg="摘要不能为空！">{{ $data->description}}</textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="publishtime" value="{{ $data->publishtime}} " onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" id="datemin" class="input-text Wdate">
            </div>
        </div>
        <!-- <div class="row cl">

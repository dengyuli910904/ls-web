...
@section('content')
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 新闻管理 <span class="c-gray en">&gt;</span> 图片新闻 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						...
						<tr class="text-c">
							...
							<td class="td-manage">
								<a style="text-decoration:none" class="ml-5" onClick="picture_edit('图片管理','{{ url('admin/news/pictures/list') }}','{{ $p->id }}')" href="javascript:;" title="编辑">
								...
								<a style="text-decoration:none" class="ml-5" onClick="picture_edit('编辑','{{ url('admin/news/pictures/edit') }}','{{ $p->id }}')" href="javascript:;" title="编辑">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a> 
...
@section('scripts')
	...
	function picture_del(obj,id){
		layer.confirm('确认要删除吗？',function(index){
			$.ajax({
	              url: "/admin/news/pictures/delete",
	              type:'post',
	              data:{
	                   _method: 'delete',
	                   id : id

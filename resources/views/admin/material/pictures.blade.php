		...
		<article class="cl pd-20">
			...
			<div class="mt-20">
				@foreach($data as $img)
					<div class="col-md-2">
						<div class="thumbnail">
							<img src="{{$img['url']}}" class="img-responsive" width="230px" height="300px"/>
							<div class="caption">
								<label>{{$img['name']}}</label>
								<p class="mt-20">
									{{--<a href="#" class="btn btn-primary" role="button">编辑</a>--}}
									<a href="javascript:void(0);" onclick="picture_del(this,'{{ $img['key'] }}')" class="btn btn-default" role="button">删除</a>
								</p>
							</div>
        ...
        function picture_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    ...
                    success: function(data){
                        if(data['code'] == 200){
                            $(obj).parents(".thumbnail").parent('div').remove();

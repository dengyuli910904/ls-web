    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" onclick="picture_add('新增','{{ url('admin/category/create')}}' )" href="javascript:;">
                    ...
                    @foreach($data as $key=>$val)
                        <tr class="text-c">
                            ...
                            <td class="td-manage">
                                ...
                                @endif
                                    <a style="text-decoration:none" class="ml-5" onClick="picture_edit('编辑','{{ url('admin/category/edit') }}','{{ $val->id }}')" href="javascript:;" title="编辑">
                                        <i class="Hui-iconfont">&#xe6df;</i>
                                    </a>

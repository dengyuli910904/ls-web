...
@section('content')
    <div class="page-container">
        ...
        <form class="form form-horizontal" id="form-article-add" action="{{ url('admin/homepages/store') }}" method="POST">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="{{ old('news_uuid', $data['news_uuid']) }}" palceholder="若为动态新闻或者赛事新闻，则需要填写新闻编号" name="news_uuid" id="news_uuid">
                </div>
            </div>
            <div class="row cl">

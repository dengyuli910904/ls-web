...
<div class="panel panel-default">
    ...
    <form action="{{ route('pictures.update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal ">
    ...
    <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <img src="{{$data->url}}" id="showcover" class="img-responsive" style="margin-bottom:20px;">
            ...
            <input type="hidden" id="path" value="{{$data->url}}" name="path">
            <input type="hidden" id="is_hidden" value="{{$data->is_hidden}}" name="is_hidden">
        </div>
        <div class="panel-footer">
            <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-dot-circle-o"></i> 提交</button>
            <button type="button" class="btn btn-sm btn-danger" onclick="window.location.href='{{ route('pictures.index', ['id' => $data->news_id]) }}'">返回</button>
            <!-- <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-dot-circle-o"></i> 返回新闻列表</button> -->

...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><i class="fa fa-indent red"></i><strong>添加专题</strong></h2>
        </div>
        <div class="col-lg-12">
            @if (count($errors) > 0)
        ...
        <form action="{{ route('topics.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal ">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" for="textarea-input">专题简介</label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <select name="template">
                            <option value="detail">默认</option>
                            <option value="detail-marathon">马拉松</option>
                            <option value="detail-golf">高尔夫</option>
                        </select>
                    </div>
                </div>

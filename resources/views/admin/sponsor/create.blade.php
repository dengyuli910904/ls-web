...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><i class="fa fa-indent red"></i><strong>添加赞助商</strong></h2>
        </div>
        <div class="col-lg-12">
            @if (count($errors) > 0)
        ...
        <form action="{{ route('sponsor.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal ">

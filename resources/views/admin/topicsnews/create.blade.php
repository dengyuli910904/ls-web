...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2><i class="fa fa-indent red"></i><strong>添加专题新闻</strong></h2>
        </div>
        <div class="col-lg-12">
            @if (count($errors) > 0)
        ...
        <form action="{{ route('topics-news.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal ">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-md-3 control-label" for="textarea-input">新闻编号</label>
                    <div class="col-md-9">
                        <input type="text" id="news_uuid" name="news_uuid" class="form-control" placeholder="请输入新闻编号......">
                    </div>
                </div>
                <div class="form-group">
